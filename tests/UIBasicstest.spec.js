...
test("Browser context first PlayWright test", async ({ browser }) => {
  ...
  ); // to log the url and status of the response
...
test("Logging in to the application with wrong credentials", async ({
  page,
}) => {
  await page.goto("https://www.rahulshettyacademy.com/loginpagePractise/");
  console.log(await page.title());
...
test("Logging in to the application with correct credentials", async ({
  page,
}) => {
  await page.goto("https://www.rahulshettyacademy.com/loginpagePractise/");
  console.log(await page.title());
